...
`;
  ...
  // package.json
  var config = {
    addonName: "Zotero Item Numbering",
    addonID: "itemnumbering@zotero.plugin",
    addonRef: "itemnumbering",
    addonInstance: "ItemNumbering",
    prefsPrefix: "extensions.zotero.itemnumbering"
  };
  ...
  var UIExampleFactory = class {
    ...
    static registerRightClickMenuPopup(win) {
      ztoolkit.Menu.register(
        "item",
        {
          tag: "menu",
    ...
    static async registerReaderItemPaneSection() {
      Zotero.ItemPaneManager.registerSection({
        ...
        // Optional
        bodyXHTML: '<html:h1 id="test">THIS IS TEST</html:h1><browser disableglobalhistory="true" remote="true" maychangeremoteness="true" type="content" flex="1" id="browser" style="width: 180%; height: 280px"/>',
        ...
        onRender: ({
          ...
          const title = body.querySelector("#test");
  ...
  __decorateClass([
    example
  ], UIExampleFactory, "registerItemPaneCustomInfoRow", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerItemPaneSection", 1);
  __decorateClass([
    example
  ], UIExampleFactory, "registerReaderItemPaneSection", 1);
  var PromptExampleFactory = class {
    ...
    static registerAnonymousCommandExample(window2) {
      ztoolkit.Prompt.register([
        {
          id: "search",
          callback: async (prompt) => {
            ...
            if (ids.length > 0) {
              ids.forEach((id) => {
                ...
                const ele = ztoolkit.UI.createElement(window2.document, "div", {
                  namespace: "html",
                  classList: ["command"],
                  listeners: [
                    {
...
Input: ${dialogData.inputValue}.`
  ...
  async function updatePrefsUI() {
    ...
    if (addon.data.prefs?.window == void 0) return;
  ...
  var ItemNumberingFactory = class _ItemNumberingFactory {
    ...
    static toggleNumbering() {
      ...
      new ztoolkit.ProgressWindow(addon.data.config.addonName).createLine({
        text: this.numberingEnabled ? getString("numbering-enabled") : getString("numbering-disabled"),
        type: "success",
        progress: 100
      }).show();
    }
