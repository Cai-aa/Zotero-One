...
export class DialogHelper extends UITool {
    ...
    open(title, windowFeatures = {
        ...
        this.window = openDialog(this, `dialog-${Zotero.Utilities.randomString()}-${new Date().getTime()}`, title, this.elementProps, this.dialogData, windowFeatures);
        return this;
    }
}
...
function replaceElement(elementProps, uiTool) {
    ...
    if (elementProps.tag === "select") {
                        ...
                        listeners: [
                            {
                                type: "click",
                                listener: (ev) => {
                                    const select = ev.target.parentElement
        ...
        elementProps.listeners.push({
            type: "click",
            listener: (ev) => {
                const href = ev.target?.getAttribute("zotero-href");
